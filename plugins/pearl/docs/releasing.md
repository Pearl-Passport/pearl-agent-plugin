...
The Codex, Claude, and Cursor manifests, marketplace entries, package metadata, and validators use one semantic version. Package `0.8.7` is the current sanitized read-only public release.
